...
%     MargCalib_NoZero('0531_Pitch', 'Sheet1', CalibParm.Wp, CalibParm.p, CalibParm.mb, CalibParm.R);
% % ---------------三、转换东北天坐标系---------------
...
% P_ksub1 = eye(3);
% Q_ksub1 =  diag([1e-7,1e-7,1e-6]);               % 状态噪声方差阵
...
% Roll_MSE0 = 0;
% for k = 1:Marg_Number
%    Roll_E =  Eul_AESKF_Set(k,2) - Eul_Init(2);
%    Roll_SE = Roll_E^2;
%    Roll_MSE0 = Roll_MSE0 + Roll_SE;
% end
% Roll_MSE = Roll_MSE0/Marg_Number;
% Roll_RMSE = sqrt(Roll_MSE);
% % ---------------七、作图---------------
% figure(1)
