...
set (gca,'FontSize',13);
figure(2)
plot((1:Marg_Number)/100,Eul_AccMag_Set(:,1),'m',(1:Marg_Number)/100,Eul_TACF_Set(:,1),'g',(1:Marg_Number)/100,Eul_TSAEKF_Set(:,1),'b',(1:Marg_Number)/100,Eul_SAESKF_Set(:,1),'y',(1:Marg_Number)/100,Eul_Reference_Set(:,1),'r','LineWidth',2),title('俯仰角 Pitch  '),xlabel('时间 t/s'),ylabel('θ/°'),legend('Measured','TACF','TSAEKF','SAESKF','Reference');
set (gca,'FontSize',13);
ylim([-0.3,0.25]);
figure(3)
