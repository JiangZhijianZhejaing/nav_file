...
set (gca,'FontSize',13);
figure(2)
plot((1:Marg_Number)/100,Eul_AccMag_Set(:,2),'m',(1:Marg_Number)/100,Eul_TACF_Set(:,2),'g',(1:Marg_Number)/100,Eul_TSAEKF_Set(:,2),'b',(1:Marg_Number)/100,Eul_SAESKF_Set(:,2),'y',(1:Marg_Number)/100,Eul_Reference_Set(:,2),'r','LineWidth',2),title('横滚角 Roll  '),xlabel('时间 t/s'),ylabel('γ/°'),legend('Measured','TACF','TSAEKF','SAESKF','Reference');
set (gca,'FontSize',13);
figure(3)
