...
[Gyro_Set_InitCs, Acc_Set_InitCs, Mag_Set_InitCs, Marg_Number] = ...
    MargCalib_NoZero(File, 'Sheet1', CalibParm.Wp, CalibParm.p, CalibParm.mb, CalibParm.R);
% ---------------三、转换东北天坐标系---------------
...
P_ksub1 = eye(3);
% Q_ksub1 =  diag([1e-8,1e-7,1e-8]);               % 状态噪声方差阵
Q_ksub1 =  (1e-7)*eye(3);
...
set (gca,'FontSize',13);
figure(2)
plot((1:Marg_Number)/100,Eul_AccMag_Set(:,1),'m',(1:Marg_Number)/100,Eul_ADCF_Set(:,1),'g',(1:Marg_Number)/100,Eul_SATEKF_Set(:,1),'b',(1:Marg_Number)/100,Eul_SAESKF_Set(:,1),'y',(1:Marg_Number)/100,Eul_Reference_Set(:,1),'r','LineWidth',2),title('俯仰角 Pitch  '),xlabel('时间 t/s'),ylabel('θ/°'),legend('Measured','TACF','TSAEKF','SAESKF','Reference');
set (gca,'FontSize',13);
ylim([-0.3,0.25]);
figure(3)
...
% figure(1)
% plot((1:Marg_Number)/100,Eul_SAESKF_Set(:,3),(1:Marg_Number)/100,Eul_SATEKF_Set(:,3),(1:Marg_Number)/100,Eul_ADCF_Set(:,3),(1:Marg_Number)/100,Eul_Reference_Set(:,3)),title('航向角 Yaw '),xlabel('时间 t/s'),ylabel('A/°'),legend('SAESKF','SATEKF','ADCF','Reference');
% figure(2)
% plot((1:Marg_Number)/100,Eul_SAESKF_Set(:,1),(1:Marg_Number)/100,Eul_SATEKF_Set(:,1),(1:Marg_Number)/100,Eul_ADCF_Set(:,1),(1:Marg_Number)/100,Eul_Reference_Set(:,1)),title('俯仰角 Pitch '),xlabel('时间 t/s'),ylabel('A/°'),legend('SAESKF','SATEKF','ADCF','Reference');
% figure(3)
% plot((1:Marg_Number)/100,Eul_SAESKF_Set(:,1),(1:Marg_Number)/100,Eul_SATEKF_Set(:,1),(1:Marg_Number)/100,Eul_Reference_Set(:,1)),title('俯仰角 Pitch '),xlabel('时间 t/s'),ylabel('A/°'),legend('SAESKF','SATEKF','Reference');