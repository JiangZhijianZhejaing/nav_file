function [Gyro_Set_InitCs, Acc_Set_InitCs, Mag_Set_InitCs, Marg_Number] = MargCalibrationNoZero(File_Name, Sheet_Name, Wp, P, Mb, R)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function：MARG传感器标定，输出实验室坐标系下的Marg数据，角速度未阈值内归零处理
%
% Prototype: [Gyro_Set_InitCs, Acc_Set_InitCs, Mag_Set_InitCs, Marg_Number] = MargCalibrationNoZero(File_Name, Sheet_Name, Wp, P, Mb, R)
...
Mag_Set_InitCs = [headingData(:,1) - R(1), headingData(:,2) - R(2), headingData(:,3) - R(3)];      % 三轴实际磁通量
