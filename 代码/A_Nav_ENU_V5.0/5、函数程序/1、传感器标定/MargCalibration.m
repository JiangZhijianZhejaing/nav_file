function [Gyro_Set_InitCS, Acc_Set_InitCS, Mag_Set_InitCS, Marg_Number] = MargCalibration(File_Name, Sheet_Name, Wp, P, Mb, R)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function：MARG传感器标定，输出实验室模块坐标系下的Marg数据
%
% Prototype: [Gyro_Set_InitCS, Acc_Set_InitCS, Mag_Set_InitCS, Marg_Number] = MargCalibration(File_Name, Sheet_Name, Wp, P, Mb, R)
...
Gyro_Threshold = max(abs(Gyro_Raw_Set_0(1:300,:)));   % 阈值计算
% 阈值内角速度归0
for i = 1 : Marg_Number
